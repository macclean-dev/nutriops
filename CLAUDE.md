...
| 🟡 Média (custo) | **Vercel migrou de Hobby pra Pro** (resolve o antigo bloqueio de deploy — confirmado 04/08, push liberou sem erro). Ciclo atual (9/jul–9/ago): US$34,87 total, US$20,00 de crédito incluso já consumido, ~US$14,87 pago sob demanda. Maior item: **Fast Origin Transfer, US$22,02** — suspeita é tráfego do Nexum, mas o painel estava com filtro "All Projects Selected" (soma de tudo, NutriOPS incluído); falta confirmar por projeto. Se a fatia do Nexum for dominante, vale reavaliar mover a Nexum pro Cloudflare Pages. |
