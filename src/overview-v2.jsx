...
function Sparkline({ data, limits, width = 220, height = 56 }) {
  if (!data?.length) {
    return (
...
function EquipmentCard({ equipment, history, onCapture }) {
  ...
  return (
    <button onClick={onCapture} style={{
      flex:'1 1 280px', minWidth:260, maxWidth:'100%',
      padding:'18px 20px',
      background:'var(--surface)', border:'1px solid var(--border-subtle)',
      borderRadius:'var(--r-lg)',
